...
SRCS	= ft_status.c ft_base.c ft_push.c ft_swap.c ft_rotate.c ft_rev_rotate.c ft_analisis.c ft_move.c ft_push_error.c ft_chunks.c ft_numbers.c ft_sorts.c ft_sorts_mid_top.c ft_sorts_mid_bot.c ft_sorts_min_top.c ft_sorts_min_bot.c ft_sorts_max_top.c ft_sorts_max_bot.c ft_sorts_mis_min.c
